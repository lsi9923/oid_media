...
export const OPS_FACTS: OpsFact[] = [
  ...
  },
  {
    ...
    risk: '증빙이 없으면 월 6~11만원(Grok 포함 여부에 따라 변동) × 12개월을 경비로 못 넣습니다.',
  },
  {
    id: 'tax-self-report',
    category: '세무',
  ...
  },
  {
    ...
    category: '세무',
    title: '미국 원천징수율은 W-8BEN 제출 여부에 달려 있습니다',
    body:
      'W-8BEN을 제출하지 않으면 미국 시청자 수익의 최대 30%가 원천징수됩니다. ' +
      '한미 조세조약(제14조, 저작권 로열티)을 적용하면 미국 시청자 수익의 10%로 낮출 수 있습니다. ' +
      '한국 종합소득세 신고 시 외국납부세액공제(소득세법 제57조)로 이중과세를 조정합니다.',
    level: 'official',
    source: 'https://support.google.com/youtube/answer/10391362 / 한미 조세조약 제14조',
    action:
      'AdSense 세금 정보에서 W-8BEN을 제출하고 조세조약 혜택을 신청하세요. 개인 계정과 사업자 계정의 세율이 다릅니다.',
    risk: '미제출 시 개인 계정은 전 세계 수익의 24%, 사업자 계정은 미국 수익의 30% 원천징수.',
  },
  {
    id: 'tax-health-insurance',
    category: '세무',
    title: '사업소득이 생기면 건강보험료가 추가 산정됩니다',
    body:
      '사업소득이 발생하면 지역건보 추가 보험료가 산정됩니다. ' +
      '직장건보 피부양자였다면 탈락해 지역가입자로 전환될 수 있습니다. ' +
      '소득 규모에 따라 월 수만원에서 수십만원까지 차이가 큽니다.',
    level: 'official',
    source: '국민건강보험법 시행령 (지역가입자 보험료 산정)',
    action: '수익이 일정 수준을 넘으면 건보료 추가분을 확인하세요. 세무사와 상의하면 정확합니다.',
    risk: '피부양자 탈락 시 예상치 못한 보험료 부담이 발생합니다.',
  },
  {
    id: 'cost-fx-loss',
    category: '비용 절감',
    title: '환전 손실과 외화 수취 수수료가 있습니다',
    body:
      '구글은 USD로 지급합니다. 시중은행 전신환 매입률 기준 약 1~1.5%의 환전 스프레드가 발생하고, ' +
      '건당 5,000~10,000원의 외화 수취 수수료도 붙습니다(은행별 상이). ' +
      '연간 수익이 500만원이면 약 7.5~10만원의 숨은 비용입니다. (추정)',
    level: 'inferred',
    action:
      '외화 수취 수수료가 낮은 은행을 비교하세요. 일부 인터넷 은행은 외화 수취 수수료가 면제됩니다.',
  },
  ...
  },
  {
    ...
    body:
      '전체 구성은 월 약 11만원(Grok 포함), 최소 구성은 월 약 6만원(Claude + Vrew)입니다. 실제로는 Flow와 미리캔버스가 무료이므로, 편수가 적으면 구독을 다 유지할 필요가 없을 수 있습니다. 해외 SaaS에는 부가세 10%도 추가됩니다.',
    level: 'inferred',
    action:
